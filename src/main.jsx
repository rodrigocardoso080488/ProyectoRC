...
//El <React.StrictMode> es un componente de React que ayuda a identificar problemas en la aplicación y proporciona advertencias en el desarrollo. Dentro de este componente se renderiza el componente principal <App />.
